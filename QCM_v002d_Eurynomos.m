...
%
%
% QCM_V002D_EURYNOMOS MATLAB code for QCM_v002d_Eurynomos.fig
%      QCM_V002D_EURYNOMOS, by itself, creates a new QCM_V002D_EURYNOMOS or raises the existing
%      singleton*.
%
%      H = QCM_V002D_EURYNOMOS returns the handle to a new QCM_V002D_EURYNOMOS or the handle to
%      the existing singleton*.
%
%      QCM_V002D_EURYNOMOS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in QCM_V002D_EURYNOMOS.M with the given input arguments.
% 
%      QCM_V002D_EURYNOMOS('Property','Value',...) creates a new QCM_V002D_EURYNOMOS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before QCM_v002d_Eurynomos_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to QCM_v002d_Eurynomos_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @QCM_v002d_Eurynomos_OpeningFcn, ...
                   'gui_OutputFcn',  @QCM_v002d_Eurynomos_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before QCM_v002d_Eurynomos is made visible.
function QCM_v002d_Eurynomos_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to QCM_v002d_Eurynomos (see VARARGIN)

% Choose default command line output for QCM_v002d_Eurynomos
...
function varargout = QCM_v002d_Eurynomos_OutputFcn(~, ~, handles) 
