function varargout = QCM_v002d_Drakon(varargin)
%
...
%
%
% QCM_V002D_DRAKON MATLAB code for QCM_v002d_Drakon.fig
%      QCM_V002D_DRAKON, by itself, creates a new QCM_V002D_DRAKON or raises the existing
%      singleton*.
%
%      H = QCM_V002D_DRAKON returns the handle to a new QCM_V002D_DRAKON or the handle to
%      the existing singleton*.
%
%      QCM_V002D_DRAKON('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in QCM_V002D_DRAKON.M with the given input arguments.
% 
%      QCM_V002D_DRAKON('Property','Value',...) creates a new QCM_V002D_DRAKON or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before QCM_v002d_Drakon_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to QCM_v002d_Drakon_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help QCM_v002d_Drakon

% Last Modified by GUIDE v2.5 06-Feb-2016 21:58:04

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @QCM_v002d_Drakon_OpeningFcn, ...
                   'gui_OutputFcn',  @QCM_v002d_Drakon_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before QCM_v002d_Drakon is made visible.
function QCM_v002d_Drakon_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to QCM_v002d_Drakon (see VARARGIN)

% Choose default command line output for QCM_v002d_Drakon
...
% UIWAIT makes QCM_v002d_Drakon wait for user response (see UIRESUME)
% uiwait(handles.primary1);


% --- Outputs from this function are returned to the command line.
function varargout = QCM_v002d_Drakon_OutputFcn(~, ~, handles) 
    ...
    if handles.din.refit_flag==0%run this if collecting dynamic data
        ...
        try
            try
                ...
                if ischar(temp)==1%this check to make sure that the extract value is a string (which wil be converted to a timepoint value)
...
if handles.din.refit_flag==0%run this if collecting live data
    ...
    if handles.din.refit.counter>str2double(get(handles.refit_end,'string'))&&...
        ...
        disp('WARNING: Your start time is greater than you end time!!');
